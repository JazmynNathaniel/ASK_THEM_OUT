...
export async function createNote(body) {
  ...
  // storage is a sender-facing diagnostic: 'local-file' in production means
  // the Redis env vars are missing and links will not survive.
  return { id, link: `/?note=${id}`, storage: backend() };
}
